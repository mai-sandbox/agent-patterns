...
# Compile the graph - this is the required 'app' export
app = supervisor_graph.compile()


# Thread-level persistence implementation
class ThreadPersistence:
    """Manages thread-level persistence for conversation state."""
    
    def __init__(self):
        self.thread_states = {}
    
    def get_state(self, thread_id: str) -> Optional[Dict[str, Any]]:
        """Get the state for a specific thread."""
        return self.thread_states.get(thread_id)
    
    def set_state(self, thread_id: str, state: Dict[str, Any]) -> None:
        """Set the state for a specific thread."""
